...
pub use errors::{AppError, AuthError, GitHubError};
pub use github::{GitHubClient, Repository, User};
...
pub use notification::{NotificationManager, NotificationService, UserNotification};
